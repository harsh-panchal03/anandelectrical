...
!(function (n) {
						...
						if ("table" != this.nodeName.toLowerCase())
							...
							if (T)
								for (g = 0, m = T.length; g < m; g++)
									T[g] && T[g].name && (C[g].sName = T[g].name);
							if (w)
							...
							if (T) for (g = 0, m = T.length; g < m; g++) _(g, T[g]);
							var L,
								F,
								N,
								j,
	...
	function B(t) {
		for (
			...
			if (h && !o._render) {
				...
				for (var p, g = t, m = d, v = g.aoData, b = 0; b < v.length; b++)
					v[b].nTr &&
						((p = G(g, b, m, "display")),
						(v[b].displayData[m] = p),
						ct(v[b].anCells[m], p));
	...
	function mt(t, e, n, a) {
		...
		return (
			e && (e = e.getAttribute("id")) && m(t.rowId)(a, e), { data: a, cells: u }
		);
	}
	function vt(t, e) {
		var n = t.aoData[e],
	...
	function Ct(e) {
		...
		if (((e.nTableWrapper = r[0]), e.sDom))
			...
			var n = Tt(e, e.layout, "top"),
				t = Tt(e, e.layout, "bottom"),
				g = te(e, "layout");
	...
	function jt(t, e, n, a, r) {
		if ("" !== n)
			for (
				...
				((i && !i(u, s._aData, t[o], r)) || (l && !l.test(u))) &&
					(t.splice(o, 1), o--),
					o++;
			}
	}
			  ...
			  "ssp" != (i = et(n)) &&
					("ajax" == i
						? At(n, {}, function (t) {
								...
								(n.iInitDisplayStart = l), s(n), T(n, !1), kt(n);
						  })
						: (kt(n), T(n, !1))))
			: setTimeout(function () {
					Et(n);
	...
	function Xt(e) {
		...
		if (e.scrollBarVis !== f && void 0 !== e.scrollBarVis)
			...
			var s =
				...
				m = u.outerWidth();
			a.css("width", A(m)),
				n.css("width", A(m)).css(f, s ? t + "px" : "0px"),
				c &&
					(l.css("width", A(m)),
					i.css("width", A(m)).css(f, s ? t + "px" : "0px")),
		...
		Qt(t, e, function (t) {
			...
			if (n.length) {
				...
				e &&
					(T(o, !0),
					setTimeout(function () {
						zt(o), qt(o, o.aiDisplay), T(o, !1), s(o, !1, !1), l && l();
					}, 0));
			}
		});
	}
	...
	function zt(t, e, n) {
		...
		for (
			...
			y && (h = y.call(m.oInstance, m, v, w(m, v)));
			for (
	...
	var he = function (t, e) {
			...
			e("row().data()", function (t) {
				...
				return void 0 === t
					...
					: (((e = n[0].aoData[this[0]])._aData = t),
					  Array.isArray(t) && e.nTr && e.nTr.id && m(n[0].rowId)(t, e.nTr.id),
					  gt(n[0], this[0], "data"),
					  this);
			}),
			e("row().node()", function () {
		...
		be =
			...
			e("cells()", function (g, t, m) {
				...
				return (
					V.isPlainObject(g) &&
						(void 0 === g.row ? ((m = g), (g = null)) : ((m = t), (t = null))),
					V.isPlainObject(t) && ((m = t), (t = null)),
					null == t
						? this.iterator("table", function (t) {
								return (
									(a = t),
						...
						: ((e = m
						  ...
						  V.extend(e.selector, { cols: t, rows: g, opts: m }),
						  e)
				);
			}),
	...
	($.datetime = function (n, a) {
		...
		($.render = {
			date: Te("toLocaleDateString"),
			datetime: Te("toLocaleString"),
			time: Te("toLocaleTimeString"),
					...
					!(function t(e, n, a) {
						...
						for (var p = 0; p < f.length; p++) {
							...
							V(v.clicker).attr({
								...
								"number" != typeof g && V(v.clicker).addClass(g),
								Qt(v.clicker, { action: g }, function (t) {
