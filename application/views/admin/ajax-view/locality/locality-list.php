...
if(isset($recordDetails) && !empty($recordDetails)) {
        ...
        ?>
        	<tr>
                ...
                <td class="actions-col">
                    <a title="<?php echo $this->lang->line("edit") ?>" href="<?php echo LOCALITY_URL."showEditForm/".$encodeId ?>" class="btn btn-sm btn-info mb-1"><i class="fas fa-fw fa-pencil-alt"></i></a>
                    <button title="<?php echo $status ?>"  data-record-id="<?php echo $encodeId ?>" onclick="updateStatus(this , 'locality_master')" class="btn btn-sm btn-warning mb-1"><i class="fa fa-eye-slash fa-fw iconStatus"></i></button>
                    <button title="<?php echo $this->lang->line('delete')?>" onclick="deleteRecord(this , 'locality_master' )" data-record-id="<?php echo $encodeId ?>" class="btn btn-sm btn-danger mb-1"><i class="fa fa-trash fa-fw"></i></button>
                </td>
            </tr>
        <?php 
    ...
    ?>
    	<tr class="text-center">
    		<td colspan="5">  <?php echo $this->lang->line('no-record-found')?>  </td>
    	</tr>
    <?php 
}
